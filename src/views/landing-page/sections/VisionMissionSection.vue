<template>
	<section id="vision" class="py-16 sm:py-24 bg-gray-800 bg-opacity-50">
		<div class="w-[90%] mx-auto px-4 sm:px-6">
			<div class="grid lg:grid-cols-2 gap-12">
				<div>
					<div class="flex items-center mb-8">
						<i class='bx bx-target-lock text-4xl text-purple-400 mr-4'></i>
						<h2 class="text-3xl sm:text-4xl font-bold">Our Vision</h2>
					</div>
					<p class="text-gray-300 text-lg mb-6">
						To be the leading student-led software development initiative in Region 2,
						recognized for creating impactful technological solutions that address
						real challenges within CSU-Carig and the broader Tuguegarao community.
					</p>
					<div class="space-y-4">
				...
				<div>
					<div class="flex items-center mb-8">
						<i class='bx bx-bullseye text-4xl text-pink-400 mr-4'></i>
						<h2 class="text-3xl sm:text-4xl font-bold">Our Mission</h2>
					</div>
					<div class="space-y-6">
